  ...
  return (
    <>
      ...
      <div className="flex-1 space-y-4 p-6">
        <Link
          href="/vaccinations"
          className="inline-flex items-center gap-2 text-body font-medium text-muted-foreground hover:text-foreground"
        >
        ...
        <Card className="max-w-xl p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && <p className="text-body font-medium text-destructive">{error}</p>}
                ...
                {({ open, setOpen, value, onValueChange }) => (
                  <>
                    ...
                    <SelectContent open={open} className="max-h-64 overflow-y-auto">
                      {patients.length === 0 ? (
                        <p className="px-2 py-2 text-body font-medium text-muted-foreground">
