...
export const VALID_TRANSITIONS = Object.freeze({
  [SESSION_STATUS.CREATED]:                 [SESSION_STATUS.RECORDING, SESSION_STATUS.TRANSCRIBED, SESSION_STATUS.FAILED],
  ...
  [SESSION_STATUS.SOAP_APPROVED]:           [SESSION_STATUS.READY_FOR_PRESCRIPTION, SESSION_STATUS.GENERATING_PRESCRIPTION, SESSION_STATUS.COMPLETED],
  ...
  [SESSION_STATUS.COMPLETED]:                     [SESSION_STATUS.GENERATING_PRESCRIPTION],
...
/** States where no further user or session action should modify session data. */
...
/**
 * Consultations still in the clinical pipeline (recording → SOAP approval).
 * Excludes completed / archived consultations.
 */
export const ACTIVE_CONSULTATION_STATUSES = Object.freeze([
  SESSION_STATUS.CREATED,
  SESSION_STATUS.RECORDING,
  SESSION_STATUS.UPLOADING,
...
/** Archived consultations (SOAP approved or downstream prescription lifecycle). */
export const HISTORY_CONSULTATION_STATUSES = Object.freeze([
...
/** Statuses where an approved or draft SOAP note may exist and should be viewable in history. */
export const SOAP_VIEWABLE_SESSION_STATUSES = Object.freeze([
  SESSION_STATUS.SOAP_READY,
  SESSION_STATUS.SOAP_REVIEW_REQUIRED,
  SESSION_STATUS.SOAP_REVIEWING,
  SESSION_STATUS.SOAP_APPROVED,
...
export const AUDIT_ACTION = Object.freeze({
  ...
  SOAP_REGENERATED:          "soap_regenerated",
  ...
  SOAP_VERSION_RESTORED:     "soap_version_restored",
