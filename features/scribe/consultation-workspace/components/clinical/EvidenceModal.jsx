        ...
        {!evidence ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-600">
              This statement could not be matched to the consultation transcript. You can edit it,
              remove it, or regenerate the SOAP note.
            </p>
            <div className="flex flex-wrap gap-2">
              <Button type="button" variant="outline" size="sm" className="cursor-pointer" onClick={onEditStatement}>
                Edit Statement
              </Button>
              <Button
                type="button"
              ...
              <Button type="button" size="sm" className="cursor-pointer" onClick={onRegenerateSoap}>
                Regenerate SOAP
              </Button>
            </div>
          </div>
