/**
 * @fileoverview Structured logger for the AI Scribe domain.
 *
 ...
 *
 * Usage:
 *   const log = createLogger({ component: "SessionService", sessionId });
 *   log.info("State transition", { from: "UPLOADING", to: "UPLOADED" });
 */
 ...
 * @property {string}  component   - e.g. "SessionRepository", "AuditService"
...
export const scribeLogger = createLogger({ component: "Scribe" });
